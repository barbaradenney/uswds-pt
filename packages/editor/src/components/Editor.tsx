...
export function Editor() {
  ...
  function getCategoryForComponent(tagName: string): string {
    const categoryMap: Record<string, string[]> = {
      ...
      'Layout': ['grid-2-col', 'grid-3-col', 'grid-4-col', 'grid-sidebar-left', 'grid-sidebar-right', 'usa-accordion', 'usa-step-indicator', 'usa-process-list', 'usa-identifier', 'usa-prose'],
